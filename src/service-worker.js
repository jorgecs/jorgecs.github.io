...
// This prevents caches from different deployments from interfering
    ...
    caches.keys().then((cacheNames) => {
      return Promise.all(
        cacheNames.map((cacheName) => {
          ...
          // You can add logic here to remove specific old caches if needed
          // For now, the precache mechanism handles this automatically
        })
      );
    })
  );
